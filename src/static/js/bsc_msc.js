...
const MSS_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'address', name: '_share', type: 'address'},
      {internalType: 'address', name: '_communityFundAddr', type: 'address'},
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accSharePerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'address', name: '_communityFundAddr', type: 'address'}],
    name: 'setCommunityFundAddr',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
...
const MSC_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract IERC20', name: '_cash', type: 'address'},
      {internalType: 'contract IERC20', name: '_share', type: 'address'},
  ...
  {
    inputs: [{internalType: 'address', name: 'director', type: 'address'}],
    name: 'canClaimReward',
  ...
  {
    inputs: [],
    name: 'maxRewardClaimWhenDollarPriceLessThanOne',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [],
    name: 'maxWithdrawWhenDollarPriceLessThanOne',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [
      {internalType: 'uint256', name: '_withdrawLockupEpochs', type: 'uint256'},
      {internalType: 'uint256', name: '_rewardLockupEpochs', type: 'uint256'},
    ],
    name: 'setLockUp',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      {internalType: 'uint256', name: '_maxRewardClaimWhenDollarPriceLessThanOne', type: 'uint256'},
      {internalType: 'uint256', name: '_maxWithdrawWhenDollarPriceLessThanOne', type: 'uint256'},
    ],
    name: 'setMaxClaimAndWithdraw',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
...
async function main() {
  ...
  const rewardsMssPerWeek = (((await MSS_CHEF.sharePerBlock()) / 1e18) * 604800) / 3

  const tokens = {}
  const prices = await getBscPrices()

  await loadMssChefContract(
    App,
    tokens,
    prices,
    MSS_CHEF,
...
async function loadMssChefContract(
  App,
  tokens,
  prices,
  chef,
  ...
  const poolInfos = await Promise.all(
    [...Array(poolCount).keys()].map(
      async x => await getBscPoolInfo(App, chefContract, chefAddress, x, pendingRewardsFunction)
    )
  )
