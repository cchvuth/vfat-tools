...
const BAKE_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract BakeryToken', name: '_bake', type: 'address'},
      {internalType: 'address', name: '_devAddr', type: 'address'},
      {internalType: 'uint256', name: '_bakeStartBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_startBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_bonusEndBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_bonusBeforeBulkBlockSize', type: 'uint256'},
      {internalType: 'uint256', name: '_bonusBeforeCommonDifference', type: 'uint256'},
      {internalType: 'uint256', name: '_bonusEndCommonDifference', type: 'uint256'},
    ],
  ...
  },
  {
    inputs: [],
    name: 'bake',
    outputs: [{internalType: 'contract BakeryToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [],
    name: 'bakeBonusEndBlock',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [],
    name: 'bonusBeforeCommonDifference',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      {internalType: 'uint256', name: '_from', type: 'uint256'},
      {internalType: 'uint256', name: '_to', type: 'uint256'},
      {internalType: 'uint256', name: '_bakeInitBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_bulkBlockSize', type: 'uint256'},
      {internalType: 'uint256', name: '_commonDifference', type: 'uint256'},
    ],
    name: 'getTotalRewardInfoInSameCommonDifference',
    outputs: [{internalType: 'uint256', name: 'totalReward', type: 'uint256'}],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accBakePerShare', type: 'uint256'},
...
async function loadBscBakeChefContract(
  App,
  tokens,
  prices,
  chef,
  ...
  const poolInfos = await Promise.all(
    [...Array(poolCount).keys()].map(
      async x => await getBscBakePoolInfo(App, chefContract, chefAddress, x, pendingRewardsFunction)
    )
  )
