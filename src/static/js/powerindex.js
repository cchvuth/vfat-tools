...
async function loadCvpContract(
  App,
  chef,
  chefAddress,
  chefAbi,
  ...
  _print(
    `The claim numbers below are not correct, they are showing the full unvested amount. You will receive up to 99% less when claiming.\n`
  )
