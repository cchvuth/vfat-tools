...
const CREAM_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract CreamToken', name: '_cream', type: 'address'},
      {internalType: 'contract MilkShake', name: '_milkshake', type: 'address'},
      {internalType: 'address', name: '_devFeeAddr', type: 'address'},
      {internalType: 'uint256', name: '_creamPerBlock', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'contract IBEP20', name: '_lpToken', type: 'address'}],
  ...
  },
  {
    inputs: [],
    name: 'cream',
    outputs: [{internalType: 'contract CreamToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {inputs: [], name: 'massUpdatePools', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'milkshake',
    outputs: [{internalType: 'contract MilkShake', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accCreamPerShare', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{internalType: 'address', name: '_devFeeAddr', type: 'address'}],
    name: 'setDevFee',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{internalType: 'address', name: '_taxTo', type: 'address'}],
    name: 'setTaxAddr',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{internalType: 'uint256', name: '_creamPerBlock', type: 'uint256'}],
    name: 'updateCreamPerBlock',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
...
async function main() {
  ...
  const rewardsPerWeek = (((await CREAM_CHEF.creamPerBlock()) / 1e18) * 604800) / 3

  const rewardsPerWeek2 = (((await CREAM_CHEF2.rewardPerBlock()) / 1e18) * 604800) / 3
...
async function loadBscChefContract2(
  App,
  tokens,
  prices,
  chef,
