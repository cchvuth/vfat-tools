...
const BSC_SWAP_ABI = [
  ...
  {
    anonymous: false,
    inputs: [{indexed: false, internalType: 'uint256', name: 'newDepositFee', type: 'uint256'}],
    name: 'NewDepositFee',
    type: 'event',
  },
  {
  ...
  {
    anonymous: false,
    inputs: [{indexed: false, internalType: 'uint256', name: 'newWithdrawFee', type: 'uint256'}],
    name: 'NewWithdrawFee',
    type: 'event',
  },
  {
  ...
  {
    inputs: [{internalType: 'uint256', name: 'newWithdrawFee', type: 'uint256'}],
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'defaultDepositFee', type: 'uint256'},
      {internalType: 'uint256', name: 'defaultWithdrawFee', type: 'uint256'},
...
async function loadBscSynthetixPoolInfo(
  App,
  tokens,
  prices,
  stakingAbi,
...
async function loadBscSynthetixPool(App, tokens, prices, abi, address, rewardTokenFunction, stakeTokenFunction) {
  const info = await loadBscSynthetixPoolInfo(
    App,
    tokens,
    prices,
    abi,
...
async function loadBscBasisFork(data) {
  ...
  let p1 = await loadBscSynthetixPool(
    App,
    tokens,
    prices,
    data.PoolABI,
  ...
  if (data.SharePool2) {
    let p3 = await loadBscSynthetixPool(
      App,
      tokens,
      prices,
      data.PoolABI,
  ...
  let p2 = await loadBscSynthetixPool(
    App,
    tokens,
    prices,
    data.PoolABI,
