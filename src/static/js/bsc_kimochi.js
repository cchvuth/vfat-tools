...
const KIMOCHI_CHEF_ABI = [
  {
    inputs: [{internalType: 'contract IERC20', name: '_referralLPToken', type: 'address'}],
  ...
  },
  {
    ...
    inputs: [
      ...
      {indexed: true, internalType: 'uint256', name: 'stakeAmountLPLv1', type: 'uint256'},
      {indexed: true, internalType: 'uint256', name: 'stakeAmountLPLv2', type: 'uint256'},
    ],
  ...
  },
  {
    ...
    inputs: [
      {indexed: true, internalType: 'address', name: 'user', type: 'address'},
      {indexed: true, internalType: 'uint256', name: 'percentForReferLv1', type: 'uint256'},
      {indexed: true, internalType: 'uint256', name: 'percentForReferLv2', type: 'uint256'},
    ],
  ...
  },
  {
    ...
    inputs: [
      {indexed: true, internalType: 'address', name: 'user', type: 'address'},
      {indexed: false, internalType: 'contract IERC20', name: 'referralLPToken', type: 'address'},
    ],
  ...
  },
  {
    ...
    inputs: [
      {indexed: true, internalType: 'address', name: 'user', type: 'address'},
      {indexed: true, internalType: 'uint256', name: 'pid', type: 'uint256'},
      {indexed: false, internalType: 'address', name: 'teamAddress', type: 'address'},
    ],
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'uint256', name: '_percentLockReward', type: 'uint256'},
      {internalType: 'uint256', name: '_percentForDev', type: 'uint256'},
      {internalType: 'uint256', name: '_percentForBurn', type: 'uint256'},
      {internalType: 'uint256', name: '_halvingAfterBlock', type: 'uint256'},
      {internalType: 'uint256[]', name: '_rewardMultiplier', type: 'uint256[]'},
      {internalType: 'uint256', name: '_lockFromBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_lockToBlock', type: 'uint256'},
    ],
    name: 'add',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'uint256[]', name: '_halvingAtBlock', type: 'uint256[]'},
      {internalType: 'uint256[]', name: '_rewardMultiplier', type: 'uint256[]'},
      {internalType: 'uint256', name: '_startBlock', type: 'uint256'},
    ],
    name: 'getMultiplier',
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'percentLockReward', type: 'uint256'},
      {internalType: 'uint256', name: 'percentForDev', type: 'uint256'},
      {internalType: 'uint256', name: 'percentForBurn', type: 'uint256'},
      {internalType: 'uint256', name: 'finishBonusAtBlock', type: 'uint256'},
      {internalType: 'uint256', name: 'startBlock', type: 'uint256'},
      {internalType: 'uint256', name: 'totalLock', type: 'uint256'},
      {internalType: 'uint256', name: 'lockFromBlock', type: 'uint256'},
      {internalType: 'uint256', name: 'lockToBlock', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [
      {internalType: 'uint256', name: '_stakeAmountLPLv1', type: 'uint256'},
      {internalType: 'uint256', name: '_stakeAmountLPLv2', type: 'uint256'},
    ],
  ...
  {
    inputs: [
      {internalType: 'uint256', name: '_percentForReferLv1', type: 'uint256'},
      {internalType: 'uint256', name: '_percentForReferLv2', type: 'uint256'},
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'lastUnlockBlock', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
...
async function main() {
  ...
  await loadBscKimochiChefContract(
    App,
    tokens,
    prices,
    KIMOCHI_CHEF,
...
async function loadBscKimochiChefContract(
  App,
  tokens,
  prices,
  chef,
  ...
  const poolInfos = await Promise.all(
    [...Array(poolCount).keys()].map(
      async x => await getKimochiPoolInfo(App, chefContract, chefAddress, x, pendingRewardsFunction)
    )
  )
  ...
  for (i = 0; i < poolCount; i++) {
    if (poolPrices[i]) {
      printChefPool(
        ...
        rewardTokenTicker,
        poolInfos[i].rewardToken.address,
        pendingRewardsFunction
      )
    }
  }
