...
const SOUP_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'address', name: '_soup', type: 'address'},
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accSoupPerShare', type: 'uint256'},
...
const SOUPS_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'address', name: '_soups', type: 'address'},
      {internalType: 'uint256', name: '_startBlock', type: 'uint256'},
    ],
    stateMutability: 'nonpayable',
    type: 'constructor',
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'allocPoint', type: 'uint256'},
      {internalType: 'uint256', name: 'lastRewardBlock', type: 'uint256'},
      {internalType: 'uint256', name: 'accSsoupPerShare', type: 'uint256'},
      {internalType: 'bool', name: 'isStarted', type: 'bool'},
    ],
    stateMutability: 'view',
    type: 'function',
...
const SOUP_BOARDROOM_ABI = [
  ...
  {
    inputs: [
      {internalType: 'contract IERC20', name: '_dollar', type: 'address'},
...
async function main() {
  ...
  const rewardsSoupPerWeek = (((await SOUP_CHEF.epochSoupPerBlock(0)) / 1e18) * 604800) / 3
  const rewardsSoupsPerWeek = (((await SOUPS_CHEF.soupsPerBlock()) / 1e18) * 604800) / 3
  ...
  let br = await loadBoardroom(
    App,
    prices,
    SOUPS_BOARDROOM_ADDR,
    SOUP_BOARDROOM_ORACLE_ADDR,
    lptAddress,
    rewardTokenAddress,
    stakeTicker,
    rewardTicker,
...
async function loadSoupChefContract(
  App,
  tokens,
  prices,
  chef,
