...
const RULER_POOL_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      {indexed: false, internalType: 'bool', name: 'old', type: 'bool'},
      {indexed: false, internalType: 'bool', name: '_new', type: 'bool'},
    ],
    name: 'PausedStatusUpdated',
    type: 'event',
  },
  {
    anonymous: false,
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'address', name: '_bonusTokenAddr', type: 'address'},
      {internalType: 'uint48', name: '_startTime', type: 'uint48'},
      {internalType: 'uint256', name: '_weeklyRewards', type: 'uint256'},
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'address[]', name: '_bonusTokenAddrs', type: 'address[]'},
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'address', name: '_lpToken', type: 'address'},
      {internalType: 'uint256', name: '_poolBonusId', type: 'uint256'},
    ],
    name: 'collectDust',
    outputs: [],
    stateMutability: 'nonpayable',
    ...
    outputs: [
      {
        components: [
          {
            components: [
              {internalType: 'address', name: 'bonusTokenAddr', type: 'address'},
              ...
              {internalType: 'uint256', name: 'accRewardsPerToken', type: 'uint256'},
              {internalType: 'uint256', name: 'remBonus', type: 'uint256'},
            ],
            internalType: 'struct IBonusRewards.Bonus[]',
            name: 'bonuses',
            type: 'tuple[]',
          },
          {internalType: 'uint256', name: 'lastUpdatedAt', type: 'uint256'},
        ],
        internalType: 'struct IBonusRewards.Pool',
        name: '',
        type: 'tuple',
      },
    ],
    ...
    outputs: [
      {
        components: [
          ...
          {internalType: 'uint256[]', name: 'rewardsWriteoffs', type: 'uint256[]'},
        ],
  ...
  {
    inputs: [{internalType: 'address[]', name: '_responders', type: 'address[]'}],
    name: 'setResponders',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
...
async function getRulerPoolInfo(App, pool, lpAddress) {
  const [poolInfo, [userInfo, rewards]] = await App.ethcallProvider.all([
    pool.getPool(lpAddress),
    pool.getUser(lpAddress, App.YOUR_ADDRESS),
...
function printRulerContractLinks(
  App,
  rulerAbi,
  rulerAddr,
  lpAddress,
...
async function main() {
  ...
  const poolInfos = await Promise.all(lpAddresses.map(async x => await getRulerPoolInfo(App, RULER_POOL, x)))
